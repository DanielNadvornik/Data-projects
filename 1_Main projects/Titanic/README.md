For the famous Titanic dataset, I've created two classification models with two different approaches - logit model with initial assumptions for variable selection
